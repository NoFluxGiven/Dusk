...
function mifune_zanmato:OnSpellStart()
	if IsServer() then
		...
		local particleTrailName = "particles/units/heroes/hero_mifune/ember_spirit_sleightoffist_trail.vpcf"
		local particleCastName = "particles/units/heroes/hero_mifune/zanmato_cast.vpcf"
...
function modifier_zanmato_caster:OnCreated()
	self:GetParent():AddNoDraw()
end

function modifier_zanmato_caster:OnDestroy()

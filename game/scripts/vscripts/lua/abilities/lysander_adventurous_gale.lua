...
LinkLuaModifier("modifier_adventurous_gale","lua/abilities/lysander_adventurous_gale",LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_adventurous_gale_movespeed","lua/abilities/lysander_adventurous_gale",LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_adventurous_gale_buff","lua/abilities/lysander_adventurous_gale",LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_adventurous_gale_push","lua/abilities/lysander_adventurous_gale",LUA_MODIFIER_MOTION_NONE)

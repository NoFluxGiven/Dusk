...
LinkLuaModifier("modifier_captains_compass","lua/abilities/lysander_captains_compass",LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_captains_compass_buff_show","lua/abilities/lysander_captains_compass",LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_captains_compass_buff","lua/abilities/lysander_captains_compass",LUA_MODIFIER_MOTION_NONE)

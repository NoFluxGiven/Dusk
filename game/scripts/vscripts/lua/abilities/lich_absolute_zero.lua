...
LinkLuaModifier("modifier_absolute_zero","lua/abilities/lich_absolute_zero",LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_absolute_zero_aura","lua/abilities/lich_absolute_zero",LUA_MODIFIER_MOTION_NONE)

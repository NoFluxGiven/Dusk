...
function shard_magus_cryst_whorl:GetCooldown()
	...
	local t_cd_reduc = self:GetCaster():FindTalentValue("special_bonus_shard_magus_4") or 0
...
function shard_magus_cryst_whorl:OnSpellStart()
	...
	local t_damage_bonus = self:GetCaster():FindTalentValue("special_bonus_shard_magus_1") or 0

...
LinkLuaModifier("modifier_boltblast_slow","lua/abilities/lightning_boltblast",LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_boltblast","lua/abilities/lightning_boltblast",LUA_MODIFIER_MOTION_NONE)

...
--[[
  ...
  -Ensure that you have the duskdota_attachments.xml, duskdota_attachments.js, and duskdota_attachments.css files in your panorama content folder to use the GUI.
  -Ensure that duskdota_attachments.xml is included in your custom_ui_manifest.xml with
    <CustomUIElement type="Hud" layoutfile="file://{resources}/layout/custom_game/duskdota_attachments.xml" />

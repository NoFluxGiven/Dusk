...
--[[
  ...
  -Ensure that you have the duskdota_notifications.xml, duskdota_notifications.js, and duskdota_notifications.css files in your panorama content folder.
  -Ensure that duskdota_notifications.xml is included in your custom_ui_manifest.xml with
    <CustomUIElement type="Hud" layoutfile="file://{resources}/layout/custom_game/duskdota_notifications.xml" />

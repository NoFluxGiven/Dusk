...
--[[
  ...
  -Ensure that you have the duskdota_worldpanels.xml in your panorama content layout folder.
  -Ensure that you have the duskdota_worldpanels.js in your panorama content scripts folder.
  -Ensure that duskdota_worldpanels.xml is included in your custom_ui_manifest.xml with
    <CustomUIElement type="Hud" layoutfile="file://{resources}/layout/custom_game/duskdota_worldpanels.xml" />
